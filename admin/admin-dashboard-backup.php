...
<head>
    ...
    <meta name="apple-mobile-web-app-title" content="ElectroZot Admin">
...
<body id="page-top">
    ...
    <!-- Booking Alert Modal now included in nav.php for all pages -->
    
    <!-- Rejection Alert Modal now included in footer for all pages -->
