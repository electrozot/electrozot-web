...
-->
                ...
                -->
                  ...
                  $result ="SELECT count(*) FROM tms_user where t_booking_status = 'Approved' || t_booking_status = 'Pending' ";
                  $stmt = $mysqli->prepare($result);
                  $stmt->execute();
...
-->
                ...
                <div class="card mb-3">
                  ...
                  $ret="SELECT * FROM tms_user where t_booking_status = 'Approved' || t_booking_status = 'Pending' "; //get all bookings
