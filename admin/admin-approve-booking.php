  ...
  if(isset($_POST['approve_booking']))
    {
           ...
           //$t_tech_id  = $_POST['t_tech_id'];
            ...
            $query="update tms_user set  t_booking_status=? where u_id=?";
            $stmt = $mysqli->prepare($query);
            $rc=$stmt->bind_param('si',  $t_booking_status, $u_id);
            $stmt->execute();
                if($stmt)
                {
     ...
     <div id="wrapper">
        ...
        -->
            ...
            <div class=" form-group">
                                 ...
                                 <input type="text" readonly value="<?php echo $row->t_tech_category;?>" class="form-control" name="t_tech_category">
                             </div>
                             <div class="form-group">
                             ...
                             <div class="form-group">
                                 ...
                                 <input type="text" readonly value="<?php echo $row->t_booking_date;?>" class="form-control" id="exampleInputEmail1" name="t_booking_date">
                             </div>
