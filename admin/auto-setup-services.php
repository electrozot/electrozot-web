<?php
// Auto-setup script - Runs automatically to populate services
...
$check = $mysqli->query("SELECT COUNT(*) as count FROM tms_service");
$result = $check->fetch_assoc();

// Only populate if no services exist or very few services
if($result['count'] < 10) {
    ...
    return 0; // Services already exist
}
?>
