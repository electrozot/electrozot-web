...
<body style="background: linear-gradient(180deg, #f8f9fa 0%, #fff5f7 100%); min-height: 100vh;">
    ...
    <!-- Hero Section -->
    <section class="services-hero" style="background: linear-gradient(135deg, #ffe5e8 0%, #fff0f2 50%, #ffe5e8 100%); padding: 60px 0 40px 0;">
    <div class="container">
    ...
    <div class="container" style="padding-top: 30px; padding-bottom: 40px;">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 mb-3">
                <div class="card h-100 service-card-compact border-0 shadow-sm" style="background: linear-gradient(180deg, #fff 0%, #ffe5e8 100%); border-radius: 15px; overflow: hidden;">
            ...
            <div class="col-lg-4 col-md-6 mb-3">
                <div class="card h-100 service-card-compact border-0 shadow-sm" style="background: linear-gradient(180deg, #fff 0%, #fff0f5 100%); border-radius: 15px; overflow: hidden;">
            ...
            <div class="col-lg-4 col-md-6 mb-3">
                <div class="card h-100 service-card-compact border-0 shadow-sm" style="background: linear-gradient(180deg, #fff 0%, #f0f8ff 100%); border-radius: 15px; overflow: hidden;">
        ...
        <div class="row mt-4">
            ...
            <div class="col-lg-4 col-md-6 mb-3">
                <div class="card h-100 feature-card-compact border-0 shadow-sm" style="background: linear-gradient(180deg, #fff 0%, #fff0f5 100%); border-radius: 12px; overflow: hidden;">
                    <div class="card-body text-center" style="padding: 20px;">
                        <div class="feature-icon-wrapper mb-3">
                        ...
                        <p class="card-text" style="font-size: 0.8rem; color: #6c757d; line-height: 1.6; margin: 0;">
                            All our repair and installation services are backed by a 30-day warranty. If the same issue reoccurs, we'll fix it for free.
                        </p>
                    </div>
                </div>
            </div>
