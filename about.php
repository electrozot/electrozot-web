...
<body style="background: linear-gradient(180deg, #FAF5FF 0%, #FFF5F7 100%); min-height: 100vh; padding-bottom: 70px;">
    ...
    <section class="about-hero" style="background: linear-gradient(135deg, #E9D5FF 0%, #FDF2F8 50%, #FEF3C7 100%); padding: 140px 0 60px 0; margin-top: -56px; position: relative; overflow: hidden;">
        ...
        <div class="container" style="position: relative; z-index: 2;">
            <div class="text-center">
                <div class="mb-3" style="display: inline-block; background: rgba(168, 85, 247, 0.15); padding: 8px 20px; border-radius: 50px; border: 2px solid #A855F7;">
    ...
    <div class="container" style="padding-top: 40px; padding-bottom: 40px;">
        ...
        <div class="row mb-4 align-items-center">
            <div class="col-lg-6 mb-4 mb-lg-0">
                <div class="about-image-card border-0 shadow-lg" style="border-radius: 20px; overflow: hidden; background: white; border: 3px solid #E9D5FF;">
            ...
            <div class="col-lg-6">
                <div class="about-content-card border-0 shadow-lg h-100" style="border-radius: 20px; padding: 30px; background: white;">
                    <div class="mb-3" style="display: inline-block; background: linear-gradient(135deg, #A855F7 0%, #EC4899 100%); padding: 6px 18px; border-radius: 50px;">
                        <span style="color: white; font-weight: 700; font-size: 0.8rem; letter-spacing: 1px;">WHO WE ARE</span>
                    </div>
                    <h2 class="about-heading mb-3" style="font-size: 1.8rem; font-weight: 800; color: #2d3748; line-height: 1.3;">
                        Our Commitment to <span style="color: #A855F7;">Excellence</span>
                    </h2>
                    <p style="font-size: 0.95rem; color: #4a5568; line-height: 1.7; margin-bottom: 18px;">
                        Welcome to <strong style="color: #EC4899;">ElectroZot</strong>, your expert provider for Electronic Repair, Electrical Installation, and Plumbing Solutions. Our entire operation is centered on a single goal: delivering service defined by <strong>Trust, Quality, and Perfection</strong>.
                    </p>
                    <p style="font-size: 0.95rem; color: #4a5568; line-height: 1.7; margin-bottom: 18px;">
                    ...
                    <p style="font-size: 0.95rem; color: #4a5568; line-height: 1.7; margin-bottom: 20px;">
                    ...
                    <div class="warranty-card" data-toggle="modal" data-target="#warrantyModal" style="background: linear-gradient(135deg, #A855F7 0%, #EC4899 100%); border-radius: 12px; padding: 20px; box-shadow: 0 6px 20px rgba(168, 85, 247, 0.3); cursor: pointer; transition: all 0.3s ease;">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                <div class="warranty-icon" style="width: 50px; height: 50px; border-radius: 50%; background: rgba(255, 255, 255, 0.2); display: flex; align-items: center; justify-content: center; margin-right: 15px; backdrop-filter: blur(10px);">
                                    <i class="fas fa-shield-alt" style="font-size: 1.5rem; color: white;"></i>
                                </div>
                                <div>
                                    <h5 class="mb-1" style="font-size: 1.1rem; font-weight: 700; color: white;">Our Warranty</h5>
                                    <p class="mb-0" style="font-size: 0.9rem; color: rgba(255,255,255,0.95);">We stand by our work with a <strong style="color: #FEF3C7;">1-Month Service Warranty</strong> on all repairs.</p>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="warrantyModal" tabindex="-1" role="dialog" aria-labelledby="warrantyModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content" style="border-radius: 20px; border: none; overflow: hidden;">
                <div class="modal-header" style="background: linear-gradient(135deg, #7DD3C0 0%, #A7E9F5 100%); border: none; padding: 25px 30px;">
                    <div class="d-flex align-items-center">
                ...
                <div class="modal-body" style="padding: 35px 40px; background: #f8f9fa;">
                    <div class="warranty-intro mb-4" style="background: white; padding: 20px; border-radius: 15px; border-left: 4px solid #7DD3C0;">
                        <p style="font-size: 1rem; color: #2d3748; margin: 0; line-height: 1.7;">
                            <strong style="color: #5EBBAA;">Electrozot</strong> provides a comprehensive <strong>1-Month Service Warranty</strong> on all repair and installation services. This warranty ensures your peace of mind and demonstrates our commitment to quality workmanship.
                        </p>
                    </div>

                    <h6 style="font-size: 1.2rem; font-weight: 700; color: #2d3748; margin-bottom: 20px;">
                        <i class="fas fa-check-circle" style="color: #7DD3C0; margin-right: 8px;"></i>
                        Warranty Coverage
                    </h6>
                    ...
                    <h6 style="font-size: 1.2rem; font-weight: 700; color: #2d3748; margin-bottom: 20px;">
                        <i class="fas fa-exclamation-triangle" style="color: #5EBBAA; margin-right: 8px;"></i>
                        Warranty Void Conditions
                    </h6>
                    <div class="warranty-void mb-4">
                        <div class="void-item mb-3" style="background: white; padding: 18px; border-radius: 12px; border-left: 4px solid #7DD3C0;">
                            <div class="d-flex align-items-start">
                                <div style="min-width: 35px; height: 35px; background: linear-gradient(135deg, #7DD3C0 0%, #A7E9F5 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-right: 15px;">
                        ...
                        <div class="void-item" style="background: white; padding: 18px; border-radius: 12px; border-left: 4px solid #7DD3C0;">
                            <div class="d-flex align-items-start">
                                <div style="min-width: 35px; height: 35px; background: linear-gradient(135deg, #7DD3C0 0%, #A7E9F5 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-right: 15px;">
                    ...
                    <div class="warranty-note" style="background: linear-gradient(135deg, #E0F7F4 0%, #F0FDFA 100%); padding: 20px; border-radius: 15px; border: 2px solid #7DD3C0;">
                        <div class="d-flex align-items-start">
                            <i class="fas fa-info-circle" style="color: #5EBBAA; font-size: 1.5rem; margin-right: 15px; margin-top: 3px;"></i>
                            <div>
                                ...
                                <p style="font-size: 0.95rem; color: #4a5568; margin: 0; line-height: 1.7;">
                                    To claim warranty service, please retain your original service invoice and contact us within the warranty period. Our team will inspect the issue and determine coverage eligibility. For any questions or warranty claims, please call <strong style="color: #5EBBAA;">7559606925</strong>.
                                </p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer" style="background: white; border: none; padding: 20px 40px 90px 40px;">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal" style="padding: 10px 25px; border-radius: 50px;">Close</button>
                    <a href="tel:7559606925" class="btn" style="background: linear-gradient(135deg, #7DD3C0 0%, #A7E9F5 100%); color: white; padding: 10px 25px; border-radius: 50px; border: none;">
