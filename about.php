...
<body style="background: linear-gradient(180deg, #f8f9fa 0%, #fff5f7 100%); min-height: 100vh;">
    ...
    <section class="about-hero" style="background: linear-gradient(135deg, #e0f7f4 0%, #f0fdf9 50%, #e0f7f4 100%); padding: 100px 0 80px 0; position: relative; overflow: hidden;">
        ...
        <div class="container" style="position: relative; z-index: 2;">
            <div class="text-center">
                <div class="mb-3" style="display: inline-block; background: rgba(17, 153, 142, 0.15); padding: 10px 24px; border-radius: 50px; border: 2px solid #11998e;">
                    <span style="color: #11998e; font-weight: 700; font-size: 0.95rem; letter-spacing: 2px;">ABOUT US</span>
                </div>
                <h1 class="about-title" style="font-size: 3rem; font-weight: 900; color: #2d3748; margin-bottom: 20px; text-shadow: 2px 2px 8px rgba(0,0,0,0.1);">
                    <i class="fas fa-bolt" style="color: #11998e; margin-right: 15px;"></i>
                    ELECTROZOT
                </h1>
    ...
    <div class="container" style="padding-top: 60px; padding-bottom: 60px;">
        ...
        <nav aria-label="breadcrumb" class="mb-5">
            <ol class="breadcrumb about-breadcrumb" style="background: white; border-radius: 15px; padding: 15px 25px; box-shadow: 0 4px 15px rgba(0,0,0,0.08); border-left: 4px solid #11998e;">
                <li class="breadcrumb-item">
                    <a href="index.php" style="color: #11998e; text-decoration: none; font-size: 1rem; font-weight: 600; transition: all 0.3s ease;">
        ...
        <div class="row mb-5 align-items-center">
            ...
            <div class="col-lg-6">
                <div class="about-content-card border-0 shadow-lg h-100" style="border-radius: 25px; padding: 40px; background: white;">
                    <div class="mb-4" style="display: inline-block; background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%); padding: 8px 20px; border-radius: 50px;">
                    ...
                    <h2 class="about-heading mb-4" style="font-size: 2.2rem; font-weight: 800; color: #2d3748; line-height: 1.3;">
                        Our Commitment to <span style="color: #11998e;">Excellence</span>
                    </h2>
                    ...
                    <div class="warranty-card" data-toggle="modal" data-target="#warrantyModal" style="background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%); border-radius: 15px; padding: 25px; box-shadow: 0 8px 25px rgba(17, 153, 142, 0.3); cursor: pointer; transition: all 0.3s ease;">
        ...
        <div class="row mb-5 mt-5">
            <div class="col-lg-12">
                <div class="text-center mb-5">
                    <div class="mb-3" style="display: inline-block; background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%); padding: 8px 20px; border-radius: 50px;">
                    ...
                    <h3 class="section-heading" style="font-size: 2.5rem; font-weight: 800; color: #2d3748; margin-bottom: 15px;">
                        Our Expert <span style="color: #11998e;">Solutions</span>
                    </h3>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="solution-card border-0 shadow-lg h-100" style="border-radius: 20px; overflow: hidden; background: white; transition: all 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275);">
                            <div class="solution-card-header" style="background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%); padding: 30px; text-align: center;">
        ...
        <div class="row mt-5 pt-5">
            <div class="col-lg-12">
                <div class="text-center mb-5">
                    ...
                    <h3 class="section-heading" style="font-size: 2.5rem; font-weight: 800; color: #2d3748; margin-bottom: 15px;">
                        Our Core <span style="color: #11998e;">Values</span>
                    </h3>
                    <p style="font-size: 1.1rem; color: #6c757d; max-width: 600px; margin: 0 auto;">The principles that guide everything we do</p>
                </div>
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="value-card border-0 shadow-lg text-center" style="border-radius: 20px; padding: 40px 30px; background: white; transition: all 0.3s ease; border-top: 5px solid #11998e;">
                            <div class="value-icon mb-4" style="width: 90px; height: 90px; margin: 0 auto; background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; box-shadow: 0 8px 20px rgba(17, 153, 142, 0.3);">
    ...
    <div class="modal fade" id="warrantyModal" tabindex="-1" role="dialog" aria-labelledby="warrantyModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content" style="border-radius: 20px; border: none; overflow: hidden;">
                <div class="modal-header" style="background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%); border: none; padding: 25px 30px;">
                    <div class="d-flex align-items-center">
                ...
                <div class="modal-body" style="padding: 35px 40px; background: #f8f9fa;">
                    <div class="warranty-intro mb-4" style="background: white; padding: 20px; border-radius: 15px; border-left: 4px solid #11998e;">
                        <p style="font-size: 1rem; color: #2d3748; margin: 0; line-height: 1.7;">
                            <strong style="color: #11998e;">Electrozot</strong> provides a comprehensive <strong>1-Month Service Warranty</strong> on all repair and installation services. This warranty ensures your peace of mind and demonstrates our commitment to quality workmanship.
                        </p>
                    </div>
                    ...
                    <h6 style="font-size: 1.2rem; font-weight: 700; color: #2d3748; margin-bottom: 20px;">
                        <i class="fas fa-exclamation-triangle" style="color: #11998e; margin-right: 8px;"></i>
                        Warranty Void Conditions
                    </h6>
                    <div class="warranty-void mb-4">
                        <div class="void-item mb-3" style="background: white; padding: 18px; border-radius: 12px; border-left: 4px solid #11998e;">
                            <div class="d-flex align-items-start">
                                <div style="min-width: 35px; height: 35px; background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-right: 15px;">
                        ...
                        <div class="void-item" style="background: white; padding: 18px; border-radius: 12px; border-left: 4px solid #11998e;">
                            <div class="d-flex align-items-start">
                                <div style="min-width: 35px; height: 35px; background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-right: 15px;">
                    ...
                    <div class="warranty-note" style="background: linear-gradient(135deg, #e0f7f4 0%, #f0fdf9 100%); padding: 20px; border-radius: 15px; border: 2px solid #11998e;">
                        <div class="d-flex align-items-start">
                            <i class="fas fa-info-circle" style="color: #11998e; font-size: 1.5rem; margin-right: 15px; margin-top: 3px;"></i>
                            <div>
                                ...
                                <p style="font-size: 0.95rem; color: #4a5568; margin: 0; line-height: 1.7;">
                                    To claim warranty service, please retain your original service invoice and contact us within the warranty period. Our team will inspect the issue and determine coverage eligibility. For any questions or warranty claims, please call <strong style="color: #11998e;">7559606925</strong>.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer" style="background: white; border: none; padding: 20px 40px;">
                    ...
                    <a href="tel:7559606925" class="btn" style="background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%); color: white; padding: 10px 25px; border-radius: 50px; border: none;">
