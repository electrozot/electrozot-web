<footer style="background: linear-gradient(135deg, #1a1a2e 0%, #16213e 100%); color: white; padding: 40px 0 20px 0;">
    <div class="container">
        <div class="row justify-content-center">
            <!-- Contact Us -->
            <div class="col-lg-4 col-md-6 mb-4">
                <h5 style="font-weight: 600; margin-bottom: 25px; color: #00d4ff; font-size: 1.1rem;">Contact Us</h5>
                <ul style="list-style: none; padding: 0;">
                    <li style="margin-bottom: 18px; display: flex; align-items: start; gap: 12px;">
                        <i class="fas fa-map-marker-alt" style="color: #00d4ff; margin-top: 3px; font-size: 1rem;"></i>
                        <span style="color: rgba(255,255,255,0.85); font-size: 0.95rem; line-height: 1.5;">Electrozot, Dharamshala</span>
                    </li>
                    <li style="margin-bottom: 18px;">
                        <a href="tel:7559606925" style="color: rgba(255,255,255,0.85); text-decoration: none; display: flex; align-items: center; gap: 12px; transition: all 0.3s;" onmouseover="this.style.color='#00d4ff'" onmouseout="this.style.color='rgba(255,255,255,0.85)'">
                            <i class="fas fa-phone" style="color: #00d4ff; font-size: 1rem;"></i>
                            <span>7559606925</span>
                        </a>
                    </li>
                    <li style="margin-bottom: 8px;">
                        <a href="mailto:electrozot.in@gmail.com" style="color: rgba(255,255,255,0.85); text-decoration: none; display: flex; align-items: center; gap: 12px; transition: all 0.3s; word-break: break-all;" onmouseover="this.style.color='#00d4ff'" onmouseout="this.style.color='rgba(255,255,255,0.85)'">
                            <i class="fas fa-envelope" style="color: #00d4ff; font-size: 1rem;"></i>
                            <span>electrozot.in@gmail.com</span>
                        </a>
                    </li>
                    <li style="margin-bottom: 18px; display: flex; align-items: start; gap: 12px;">
                        <i class="fas fa-clock" style="color: #00d4ff; margin-top: 3px; font-size: 1rem;"></i>
            ...
            <!-- Follow Us -->
            <div class="col-lg-4 col-md-6 mb-4">
                <h5 style="font-weight: 600; margin-bottom: 25px; color: #00d4ff; font-size: 1.1rem;">Follow Us</h5>
