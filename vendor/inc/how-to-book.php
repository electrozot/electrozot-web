...
<section id="how-to-book-section" class="how-to-book-section" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 60px 0; color: white; position: relative; overflow: hidden;">
    ...
    <div class="container" style="position: relative; z-index: 2;">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="booking-step-card text-center" style="background: rgba(255,255,255,0.15); border-radius: 20px; padding: 30px 20px; backdrop-filter: blur(10px); border: 1px solid rgba(255,255,255,0.2); height: 100%; transition: all 0.3s ease;">
                    ...
                    <p style="color: rgba(255,255,255,0.9); font-size: 0.95rem; line-height: 1.6;">
                        Select the service you need from our <a href="<?php echo isset($base_url) ? $base_url : ''; ?>#booking-form" style="color: #FFD700; text-decoration: none; font-weight: 600;">booking form</a> or browse our <a href="<?php echo isset($base_url) ? $base_url : ''; ?>services.php" style="color: #FFD700; text-decoration: none; font-weight: 600;">services page</a>
                    </p>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="booking-step-card text-center" style="background: rgba(255,255,255,0.15); border-radius: 20px; padding: 30px 20px; backdrop-filter: blur(10px); border: 1px solid rgba(255,255,255,0.2); height: 100%; transition: all 0.3s ease;">
                    <div class="step-number mb-3" style="background: linear-gradient(135deg, #A78BFA 0%, #8B5CF6 100%); width: 60px; height: 60px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto; font-size: 1.5rem; font-weight: bold; color: white; box-shadow: 0 5px 15px rgba(167,139,250,0.4);">
                        4
                    </div>
                    <div class="step-icon mb-3">
                        <i class="fas fa-tools" style="font-size: 2rem; color: #A78BFA;"></i>
                    </div>
                    <h4 class="font-weight-bold mb-3" style="color: white; font-size: 1.2rem;">Service Delivered</h4>
                    <p style="color: rgba(255,255,255,0.9); font-size: 0.95rem; line-height: 1.6;">
        ...
        <div class="row mt-5">
            <div class="col-12 text-center">
                <h4 class="font-weight-bold mb-4" style="color: white;">
                    <i class="fas fa-rocket" style="color: #FFD700; margin-right: 10px;"></i>Quick Booking Options
                </h4>
                <div class="row justify-content-center">
                    <div class="col-md-4 mb-3">
                        <a href="<?php echo isset($base_url) ? $base_url : ''; ?>#booking-form" class="btn btn-lg btn-light" style="border-radius: 25px; padding: 15px 30px; font-weight: 600; width: 100%; transition: all 0.3s ease;">
                            <i class="fas fa-laptop" style="color: #667eea; margin-right: 10px;"></i>Online Booking
                        </a>
                    </div>
                    <div class="col-md-4 mb-3">
                        <a href="tel:7559606925" class="btn btn-lg btn-warning" style="border-radius: 25px; padding: 15px 30px; font-weight: 600; width: 100%; transition: all 0.3s ease;">
                            <i class="fas fa-phone" style="margin-right: 10px;"></i>Call Now: 7559606925
                        </a>
                    </div>
                    <div class="col-md-4 mb-3">
                        <a href="https://wa.me/917559606925" target="_blank" class="btn btn-lg btn-success" style="border-radius: 25px; padding: 15px 30px; font-weight: 600; width: 100%; transition: all 0.3s ease;">
