...
<body>
    ...
    <div class="container">
        ...
        <h1 class="my-4">Welcome to Electrozot</h1>
        ...
        <div class="row">
            <div class="col-lg-6 mb-4">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <p class="card-text">We provide professional technician services with accountability, reliability and ease of booking skilled technicians for all your needs</p>
                    </div>
...
-->
        <!-- Portfolio Section -->
        <h2 class="center">Our Professional Technicians</h2>
        <!--Portfolio Section -->
        <hr>
        <div class="row">
            <div class="col-lg-4 col-sm-6 portfolio-item">
                <div class="card h-100">
                    <a href="#"><img class="card-img-top" src="vendor/img/tech1.jpg" alt="Technician"></a>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 portfolio-item">
                <div class="card h-100">
                    <a href="#"><img class="card-img-top" src="vendor/img/tech2.jpg" alt="Technician"></a>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 portfolio-item">
                <div class="card h-100">
                    <a href="#"><img class="card-img-top" src="vendor/img/tech3.jpg" alt="Technician"></a>
                </div>
            </div>
