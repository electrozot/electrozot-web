...
echo "<br>";
echo "<a href='user-dashboard.php' style='padding: 10px 20px; background: #ec6ead; color: white; text-decoration: none; border-radius: 5px;'>Go to Dashboard</a>";
echo " ";
echo "<a href='index.php' style='padding: 10px 20px; background: #d13abd; color: white; text-decoration: none; border-radius: 5px;'>Go to Login</a>";
?>
