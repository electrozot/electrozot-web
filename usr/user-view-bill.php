...
$verify_query = "SELECT sb_id FROM tms_service_booking WHERE sb_id = ? AND sb_user_id = ?";
...
if($check_result->num_rows > 0) {
    ...
    if($days_old > 30) {
        header('Location: user-track-booking.php?booking_id=' . $booking_id);
        exit();
    }
}
...
<head>
    ...
    <title>View Bill - Electrozot</title>
