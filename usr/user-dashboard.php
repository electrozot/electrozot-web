         ...
         <div id="content-wrapper">
             ...
             <div class="container-fluid">
                 ...
                 <div class="row">
                     ...
                     <div class="col-xl-3 col-sm-6 mb-3">
                         <div class="card text-white bg-success o-hidden h-100">
                             <div class="card-body">
                                 <div class="card-body-icon">
                                     <i class="fas fa-fw fa-clipboard"></i> <i class="fas fa-fw fa-tools"></i>
                                 </div>
                                 <div class="mr-5">Book Technician</div>
                             </div>
                             <a class="card-footer text-white clearfix small z-1" href="usr-book-technician.php">
                                 <span class="float-left">View Details</span>
                                 <span class="float-right">
                                     <i class="fas fa-angle-right"></i>
                                 </span>
                 ...
                 <div class="card mb-3">
                  ...
                  $ret="SELECT * FROM tms_technician "; //get all technicians
